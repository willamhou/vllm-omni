...
# Re-exported for modeling_audio_tokenizer.py; drops the unused position_ids param from the old signature.
from vllm_omni.diffusion.layers.rope import apply_rotary_pos_emb_single as apply_rotary_pos_emb  # noqa: F401, E402
